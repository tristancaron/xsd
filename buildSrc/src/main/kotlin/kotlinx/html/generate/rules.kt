...
val globalSuggestedAttributes = listOf(
        ...
        "CustomClick" to "id",
        "Impression" to "id",
        "StaticResource" to "creativeType",
        "Icon" to "program",
        "Icon" to "width",
        "Icon" to "height",
        "Icon" to "xPosition",
        ...
        "Icon" to "duration",
        "Icon" to "offset",
        "Icon" to "apiFramework",
        "Icon" to "pxratio",
        "CreativeExtension" to "type",
        "AdParameters" to "xmlEncoded",
        "MediaFile" to "id",
        "MediaFile" to "delivery",
        "MediaFile" to "type",
        "MediaFile" to "width",
        "MediaFile" to "height",
        "MediaFile" to "codec",
        "MediaFile" to "bitrate",
        "MediaFile" to "minBitrate",
        "MediaFile" to "maxBitrate",
        "MediaFile" to "scalable",
        "MediaFile" to "maintainAspectRatio",
        "MediaFile" to "fileSize",
        "MediaFile" to "mediaType",
        "MediaFile" to "apiFramework",
        "Mezzanine" to "id",
        "Mezzanine" to "delivery",
        "Mezzanine" to "type",
        "Mezzanine" to "width",
        "Mezzanine" to "height",
        "Mezzanine" to "codec",
        "Mezzanine" to "fileSize",
        "Mezzanine" to "mediaType",
        "InteractiveCreativeFile" to "type",
        "InteractiveCreativeFile" to "apiFramework",
        "InteractiveCreativeFile" to "variableDuration",
        "NonLinearClickTracking" to "id",
        "NonLinearClickThrough" to "uri",
        "CompanionClickThrough" to "uri",
        "CompanionClickTracking" to "id",
        "Creative" to "sequence",
        "Creative" to "apiFramework",
        "Creative" to "id",
        "Creative" to "adId",
        "Viewable" to "uri",
        "NotViewable" to "uri",
        "ViewUndetermined" to "uri",
        "Verification" to "vendor",
        "ExecutableResource" to "apiFramework",
        "ExecutableResource" to "type",
        "JavaScriptResource" to "apiFramework",
        "JavaScriptResource" to "browserOptional",
        "VerificationParameters" to "metadata",
        "AdSystem" to "version",
        "Pricing" to "model",
        "Pricing" to "currency",
        "BlockedAdCategories" to "authority",
        "VASTAdTagURI" to "uri",
        "AdServingId" to "id",
        "AdTitle" to "title",
        "Advertiser" to "name",
        "Category" to "authority",
